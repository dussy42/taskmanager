...
def desobj(obj, index=None):
    """
    helps in destructuring the slected obj into a string to increase readbility
    """
...
def print_all_products(products):
    """
    prints the selected products in a nice readble format understable by a normal user
    """

    print("Hurray🎶 here are the best offer for the Product you wanted:\n")
